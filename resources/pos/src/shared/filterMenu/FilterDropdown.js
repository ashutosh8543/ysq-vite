...
import { baseUnitOptions, paymentStatusOptions, paymentTypeOptions, statusOptions, transferStatusOptions, mileageTypeOptions } from "../../constants";
            ...
            <Dropdown.Menu className='px-7 py-5'>
                ...
                {isMileageType ?
                    <Dropdown.Header onClick={(e) => {
                        ...
                        <ReactSelect multiLanguageOption={mileageTypeFilterOptions} onChange={onMileageTypeChange} name='Mileage Type'
                            title="Mileage Type"
                            value={isReset ? mileageTypeDefaultValue[0] : mileageType} isRequired
                            defaultValue={mileageTypeDefaultValue[0]}
                            placeholder={getFormattedMessage('select.mileage-type.label')}
                        />
                    </Dropdown.Header>
                    : null}
                {isWarehouseType ?
