...
import CountryModel from "../user-profile/countryModel.js";
...
const Header = (props) => {
    ...
    const isAdmin = loginUserArray && (loginUserArray.role_id === 1 || loginUserArray.role_id === 2);
                ...
                <Nav className="align-items-stretch justify-content-between flex-row">
                    ...
                    <Dropdown className="d-flex align-items-stretch">
                        ...
                        <Dropdown.Menu>
                            ...
                            {isAdmin && (
                                <Dropdown.Item onClick={onClickCountryModel} className="px-5 fs-6">
                                    <span className="dropdown-icon me-4 text-gray-600">
