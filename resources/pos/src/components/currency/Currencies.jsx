    ...
    const columns = [
        ...
        },
        {
            ...
            cell: row => {
                ...
                isEditMode={allConfigData?.permissions && allConfigData?.permissions.includes(Permissions.EDIT_CURRENCY)?true:false}
                isDeleteMode={false}
                // isDeleteMode={allConfigData?.permissions && allConfigData?.permissions.includes(Permissions.DELETE_CURRENCY)?true:false} 
                />
            }
        }
    ];
