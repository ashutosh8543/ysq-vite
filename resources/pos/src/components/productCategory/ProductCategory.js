        ...
        },
        {
            ...
            cell: row => <ActionButton 
              ...
              goToEditProduct={handleClose}
               isEditMode={allConfigData?.permissions && allConfigData?.permissions.includes(Permissions.EDIT_PRODUCT_CATEGORY)?true:false}
               isDeleteMode={allConfigData?.permissions && allConfigData?.permissions.includes(Permissions.DELETE_PRODUCT_CATEGORY)?true:false}                 
    ...
    return (
        <MasterLayout>
            ...
            <TabTitle title={placeholderText('product-categories.title')}/>
                ...
                AddButton={allConfigData?.permissions && allConfigData?.permissions.includes(Permissions.CREATE_PRODUCT_CATEGORY)?<CreateProductCategory/>:""}
