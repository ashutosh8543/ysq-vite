...
const ProductForm = (props) => {
    ...
    const disabled =
        multipleFiles.length !== 0
            ...
            singleProduct[0]?.cn_description === productValue?.cn_description &&
            singleProduct[0]?.bn_description === productValue?.bn_description &&
    ...
    useEffect(() => {
        if (singleProduct) {
            setProductValue({
                ...
                cn_description: singleProduct ? singleProduct[0]?.cn_description : "",
                bn_description: singleProduct ? singleProduct[0]?.bn_description : "",
    ...
    const handleValidation = () => {
        ...
        else if (!productValue["cn_name"] || productValue["cn_name"].trim() === "") {
            errorss["cn_name"] = getFormattedMessage(
                "globally.input.name.validate.label"
            );
        }
        else if (!productValue["bn_name"] || productValue["bn_name"].trim() === "") {
        ...
        //     );
        // }
         else if (productValue && productValue["code"] && !codeRegex.test(productValue["code"])) {
        ...
        // }
            ...
            productValue["cn_description"].length > 100
        ) {
            errorss["cn_description"] = getFormattedMessage(
                "globally.input.notes.validate.label"
            );
        }
        else if (
            productValue["bn_description"] &&
            productValue["bn_description"].length > 100
        ) {
            errorss["bn_description"] = getFormattedMessage(
                "globally.input.notes.validate.label"
            );
        }
        else if(
            ...
            errorss["add_stock"] = getFormattedMessage(
                "purchase.product.vdgrgerquantity.validate.label"
            );
        }
            ...
            // ) {
            // } else
            // if(!singleProductTypeData.product_cost ||
    ...
    const onCountryChange = (e) => {
        setProductValue(inputs => ({ ...inputs, [e.target.name]: e.target.value }))
        setErrors("");
    };
                            ...
                            <div className="card">
                                <div className="row">
                                     {/* Country  */}
                                        <div className='col-md-4 mb-3'>
                                            ...
                                            <select className='form-control' autoFocus={true} name='country_id' value={productValue?.country_id} onChange={(e) => onCountryChange(e)} >
                                            ...
                                            <span
                                                className='text-danger d-block fw-400 fs-small mt-2'>{errors['country_id'] ? errors['country_id'] : null}</span>
                                        </div>
                                    <div className="col-md-4 mb-3">
                                        <label className="form-label">
                                            {getFormattedMessage(
                                    ...
                                    <InputGroup>
                                        <input
                                            ...
                                            onChange={(e) =>onChangeInput(e)}
                                            value={
                                                productValue &&  productValue?.product_price
                                            }
                                        />
                                        <InputGroup.Text>
                                            {frontSetting.value &&
                                ...
                                <div className="col-md-4 mb-3">
                                        ...
                                        <input
                                            ...
                                            value={  productValue &&  productValue?.add_stock}
                                            min={1}
                                        />
                                        <span className="text-danger d-block fw-400 fs-small mt-2">
                                            {errors["add_stock"]
                                ...
                                <div className="col-md-4 mb-3">
                                    ...
                                    <input
                                        ...
                                        value={
                                            productValue &&  productValue?.stock_alert
                                        }
                                        min={0}
                                    />
                                </div>
