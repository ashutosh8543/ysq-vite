        ...
        },
        {
            ...
            cell: (row) => (
                <ActionButton
                    ...
                    isEditMode={allConfigData?.permissions && allConfigData?.permissions.includes(Permissions.EDIT_PRODUCT)?true:false}
                    isDeleteMode={allConfigData?.permissions && allConfigData?.permissions.includes(Permissions.DELETE_PRODUCT)?true:false}
    ...
    return (
        <MasterLayout>
            ...
            <ReactDataTable
                ...
                onChange={onChange}
                isLoading={isLoading}
                ButtonValue={allConfigData?.permissions && allConfigData?.permissions.includes(Permissions.CREATE_PRODUCT)?getFormattedMessage("product.create.title"):""}
