...
const Brands = () => {
    ...
    const columns = [
        ...
        },
        {
            ...
            isEditMode={allConfigData?.permissions && allConfigData?.permissions.includes(Permissions.EDIT_BRAND)?true:false}
            isDeleteMode={allConfigData?.permissions && allConfigData?.permissions.includes(Permissions.DELETE_BRAND)?true:false}           
    ...
    return (
        <MasterLayout>
            ...
            AddButton={allConfigData?.permissions && allConfigData?.permissions.includes(Permissions.CREATE_BRAND)?<CreateBrands/>:""}
